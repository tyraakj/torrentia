...
export const MODEL_REGISTRY_ADDRESS = (import.meta.env.VITE_MODEL_REGISTRY_ADDRESS ||
  '0xe2cEDee4817B11716728aed3C3d7AD0438813340') as `0x${string}`

export const SPLIT_PAYMENT_ADDRESS = (import.meta.env.VITE_SPLIT_PAYMENT_ADDRESS ||
  '0xFF9c3ce76Eba5647a7d22DF9A8b699d91F4bbdDa') as `0x${string}`
